  ...
  methods: {
    ...
    getMemberLevels() {
      this.$http({
        ...
        .then(({ data }) => {
          this.dataResp.memberLevels = data.page.pageList;
        })
        .catch(e => {
          console.log(e);
        });
    ...
    generateSaleAttrs() {
      ...
      this.spu.baseAttrs = [];
      console.log("this.dataResp.baseAttrs",this.dataResp.baseAttrs);
      ...
      if (!this.dataResp.steped[1]) {
        this.$http({
          url: this.$http.adornUrl(
            `/product/attr/attrSale/list/${this.spu.catalogId}`
          ),
          method: "get",
          params: this.$http.adornParams({
            page: 1,
          ...
          this.dataResp.saleAttrs = data.page.pageList;
          data.page.pageList.forEach(item => {
